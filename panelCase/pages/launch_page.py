...
class LaunchPage(BasePage):
    ...
    DATE_DROPDOWN = (By.CSS_SELECTOR, ".form-control.reportrange-text")  # 1.ye tiklat
    CHOOSING_DATE_BTN = (By.CLASS_NAME, "weekend")  # 1.ye tıklat
    TIME_DROPDOWN = (By.CSS_SELECTOR, "input[name='endHour']")
    CHOOSING_TIME_BTN = (By.CSS_SELECTOR, "p.option__2")
    DISPLAY_TIME_DROPDOWN_BTN = (By.XPATH, ".//div[contains(@class,'qa-accordion-toggle')]")  # 0.ya tiklat
    ...
    ADVANCED_DROPDOWN_BTN = (By.XPATH, ".//div[contains(@class,'qa-accordion-toggle')]")  # 1.ye tıklat
